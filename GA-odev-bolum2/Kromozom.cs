...
namespace GA_odev_bolum2
{
    class Kromozom
    {
        ...
        public string[] t1 = new string[8];
        public string[] co1 = new string[8];
        public string[] t2 = new string[8];
        public string[] co2 = new string[8];
        ...
        {
            deger = 0;
            deger -= Convert.ToInt32(ss[0]) * Convert.ToInt32(Math.Pow(2, 7));
            for (int i = 1; i < ss.Length; i++)
            {
                deger += Convert.ToInt32(ss[i]) * Convert.ToInt32(Math.Pow(2, 7 - i));
            }
            return deger;
        }
